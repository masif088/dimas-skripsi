...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('asset-kue-kacang/images/logo-kks-128x128-1.png')}}" type="image/x-icon">
    <meta name="description" content="">


    <title>Beranda</title>
    <link rel="stylesheet" href="{{ asset('asset-kue-kacang/web/assets/mobirise-icons2/mobirise2.css') }}">
    <link rel="stylesheet" href="{{ asset('asset-kue-kacang/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('asset-kue-kacang/bootstrap/css/bootstrap-grid.min.css') }}">
    <link rel="stylesheet" href="{{ asset('asset-kue-kacang/bootstrap/css/bootstrap-reboot.min.css') }}">
    <link rel="stylesheet" href="{{ asset('asset-kue-kacang/animatecss/animate.css') }}">
...
<section data-bs-version="5.1" class="pricing02 cid-uj84co9I7k" id="pricing02-1p">
                ...
                <div class="item-wrapper">
                    ...
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5">
                            <strong>Kemasan 500 gram</strong></h5>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 content-head mb-5">
                <h1 class="mbr-section-title mbr-fonts-style mb-0 display-2">
                    <strong>Keunggulan Kue Kacang Sultan</strong></h1>
            ...
            <div class="col-12 col-lg">
                ...
                <div class="item features-without-image col-12 col-md-12 col-lg-12">
                    <div class="item-wrapper">
                        <div class="item-content">
                            <h5 class="mbr-card-title mbr-fonts-style mt-0 mb-3 mbr-number display-2">
                                <strong>02. Tahan Lama</strong></h5>

                            <p class="card-text mbr-fonts-style mt-0 mb-0 display-7">
                                Memiliki waktu expired yang lebih lama
                            </p>
                ...
                <div class="item features-without-image col-12 col-md-12 col-lg-12">
                    <div class="item-wrapper">
                        <div class="item-content">
                            <h5 class="mbr-card-title mbr-fonts-style mt-0 mb-3 mbr-number display-2">
                                <strong>03. Higienis</strong></h5>

                            <p class="card-text mbr-fonts-style mt-0 mb-0 display-7">
                                Lebih bersih dengan prosedur produksi higienis ketat</p>
        ...
        <div class="media-container-row align-center mbr-white">
            <div class="col-12">
                <p class="mbr-text mb-0 mbr-fonts-style display-7">
                    © Copyright 2024 Kue Kacang Sultan</p>
            </div>
        </div>
    </div>
</section>

...
function drawChart() {
    ...
    data.addRows([
        ...
        ['Complete', 'Hand in paper', 'complete',
            ...
            ['aaOutline', 'Outline aaaaaapaper', 'write',
            null, new Date(2015, 0, 15), daysToMilliseconds(1), 100, 'Research'],
        ['Outline', 'Outline paper', 'write',
            null, new Date(2015, 0, 6), daysToMilliseconds(1), 100, 'Research'],
            
        // ['aOutlinea', 'Outaaline paper', 'write',
        //     null, new Date(2015, 0, 10), daysToMilliseconds(1), 100, 'write'],
        ['aOutline', 'Outline aaaaaapaper', 'write',
            null, new Date(2015, 0, 15), daysToMilliseconds(1), 100, 'Research'],
